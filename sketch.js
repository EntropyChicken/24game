...
function draw() {
    ...
    if (screen === "title") {
        ...
        if(workshopScreen!==undefined) workshopScreen.numberInput.hide(); // idk why but opening console log (ctrl+shift+i) makes this appear on the title screen
        teamInput.hide(); // for good measure
    } else if (screen === "game") {
        background(220);
        level.draw();
        if (level.solved) {
